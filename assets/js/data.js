...
const TECH_DRONES = [
  {
    ...
    body: 'Zipline operates from compact <strong>distribution centers</strong> — a fenced yard lined with autonomous <strong>docking towers</strong> where drones launch, recover and recharge, then lower packages by tether. The company <strong>met directly with Mesa staff</strong> while these amendments were drafted. That fenced docking yard is a textbook <strong>aerial Fleet-Based Service</strong>.',
  },
  {
    name: 'Wing  ·  Walmart',
    ...
    body: 'Wing (a subsidiary of Alphabet) delivers Walmart orders in as little as 30 minutes. Drones launch and land from a fenced array of <strong>flat ground pads</strong> in the store parking lot — a small, screened aerial dispatch yard that is exactly what the new fleet parking, charging &amp; screening standards are written for.',
  },
  {
    ...
    body: 'Amazon’s Prime Air launches the <strong>MK30</strong> drone from a fenced ground site co-located with a delivery station — already operating right here in the Valley in <strong>Tolleson, AZ</strong>. The launch pad, support buildings, charging and staging are the heart of the new <strong>Fleet-Based Services</strong> standards.',
  },
];
...
const TECH_EV = [
  {
    ...
    tag: 'Service Stations — now powered by electrons',
...
const LEGISLATION = {
  ...
  points: [
    ...
    'So Mesa’s amendments regulate the <strong>land use</strong> — where vehicles park, charge, stage and how they’re screened — by defining “Fleet-Based Services” around <strong>ground- or aerial-based vehicles</strong> generally, rather than singling out drones.',
  ],
  takeaway: 'This keeps Mesa squarely within its land-use authority while remaining mindful of the pending state law.',
};
